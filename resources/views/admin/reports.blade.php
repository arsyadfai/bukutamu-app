...
<div class="container-fluid px-4">
    <h1 class="mt-4 text-center">Laporan Pengunjung</h1>
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item active text-center">Laporan Pengunjung Buku Tamu BBPMP Jateng</li>
    </ol>
    ...
    <form method="GET" action="{{ route('admin.reports') }}" class="row g-3 mb-4">
        ...
        <div class="col-md-4">
            ...
            <input type="text" id="search" name="search" class="form-control" placeholder="Nama Tamu" value="{{ request('search') }}">
        </div>
