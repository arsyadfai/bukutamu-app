...
<div class="container mt-5">
    ...
    <div class="form-group">
        <input type="email" class="form-control email-input @error('email') is-invalid @enderror" 
               id="email" name="email" value="{{ Auth::user()->email }}" placeholder="Email Baru" required>
        @error('email')
